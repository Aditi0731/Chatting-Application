...
public class user_2  implements ActionListener{
    ...
    user_2(){
        ...
        ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("icons1/2.png"));
        ...
        JLabel name=new JLabel("Sardaar");
        ...
        scrollPane.getVerticalScrollBar().setUnitIncrement(16); // Adjust the scrolling speed
